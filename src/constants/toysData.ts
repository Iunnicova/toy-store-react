...
export const toys: TToy[] = [
  {
    id: 1,
    title: 'Милашка Луна- антистресс дарит волшебный мёд',
    price: 5900,
    toyImage: toyBee,
    characteristic: {
      size: 55,
      material: 'Бифлекс / полистирол',
      filler: 'Мелкие шарики полистирола (пенопласт) — лёгкие и упругие.',
      age: 'от 5 лет',
  ...
  {
    id: 6,
    title: 'Кукла Ляля - антистресс приглашает дружить',
    price: 4900,
    toyImage: toyGirl,
    characteristic: {
      size: 45,
