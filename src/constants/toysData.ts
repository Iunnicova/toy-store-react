...
export const toys: TToy[] = [
  {
    ...
    description:
      'Очаровательная пчёлка Луна с баночкой волшебного мёда — мягкая игрушка, которую хочется обнимать. Яркий дизайн, крылышки, бантики и добрые глазки делают её любимицей детей.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      'Ляля — очаровательная кукла с косичками, бантиком и доброй улыбкой. Она словно создана для дружбы: мягкая, уютная и всегда готова к игре или объятиям. Её яркое платье и выразительные глаза делают её любимицей детей.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    description:
      'Жора — обаятельный плюшевый ёжик с озорным хвостиком и доброй улыбкой. Его мягкие иголочки, весёлый взгляд и уютный наряд делают его идеальным другом для игр, сна и объятий. Он любит веселиться и дарить хорошее настроение.',
  },
  {
    id: 11,
