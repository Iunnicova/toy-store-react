...
export const ControlPanel = ({ theme, setTheme }: TControlPanelProps) => {
  ...
  <div className={styles.lightDark}>
    <Button variant='toggle' className={classNames(styles.button, activeTheme === 'light' && styles.activeButton)} onClick={toggleTheme}>
      <img className={styles.img} src={sunshine} alt="Солнышко" />
    </Button>
    <Button variant='toggle' className={classNames(styles.button, activeTheme === 'dark' && styles.activeButton )} onClick={toggleTheme}>
