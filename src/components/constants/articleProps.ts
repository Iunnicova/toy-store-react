// //! ЭТОТ ФАЙЛ МНЕ НУЖЕН БУДЕТ ЕСЛИ Я В БУДУЩЕМ РЕШУ, ЧТО ПОЛЬЗОВАТЕЛЬ МОЖЕТ МЕНЯТЬ
// //! (ЦВЕТ, ФОН, И ШРИФТ) ПО СВОЕМУ УСМОТРЕНИЮ

// // Классы семейства шрифтов 'fontFamilyClasses'
// export const fontFamilyClasses = ['kumbh-sans', 'roboto', 'inter'] as const;
...
// } = [
//   { title: 'Kumbh Sans', value: 'Kumbh Sans', className: fontFamilyClasses[0] },

//   { title: 'Roboto', value: 'Roboto', className: fontFamilyClasses[1] },
//   {
//     title: 'Inter',
//     value: 'Inter',
